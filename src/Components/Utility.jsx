...
const Utility = () => {
    return (
        <> 
            ...
            <div className="bg-[url(../src/assets/images/WEBP/bg-utility.webp)] bg-no-repeat bg-cover bg-center mt-[-2px]" id='presale'>
                <div className="container pt-[20px] lg:pt-[123px] pb-[35px] lg:pb-[194px]">
                    <div className="row flex-col-reverse md:flex-row">
                        <div className="col-12 md:col-7 flex items-center" data-aos="fade-down">
                            <div className="">
                                <h3 className=' font-Josefin font-bold text-[38px] lg:text-[48px] leading-[46px] lg:leading-[61.2px] text-white'><span className='bg-[linear-gradient(90deg,#815CC8_0%,#1BABFE_100%)] inline-block text-transparent bg-clip-text'>NFT</span> Utility</h3>
                        ...
                        <div className="col-12 md:col-5 flex justify-center" data-aos="fade-up">
