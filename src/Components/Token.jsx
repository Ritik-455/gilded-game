...
const Token = () => {
    ...
    return (
        <>
            <div className="bg-[url(../src/assets/images/WEBP/bg-token.webp)] bg-center bg-cover bg-no-repeat">
                <div className="container py-[50px] xl:py-[133px]">
                    ...
                    <div className=" xl:flex gap-[24px] mt-[59px] hidden">
                        <div className=" max-w-[312px] w-full bg-custom-gradient border-[1px] border-[#4A4A4A]  rounded-[16px] hover:bg-[linear-gradient(149.67deg,#815CC8_29.44%,#1BABFE_81.54%)] hover:drop-shadow-[0_8px_35px#1BABFE] hover:border-[#8E78D3]">
                        ...
                        <div className=" max-w-[312px] w-full bg-custom-gradient border-[1px] border-[#4A4A4A]  rounded-[16px] hover:bg-[linear-gradient(149.67deg,#815CC8_29.44%,#1BABFE_81.54%)] hover:drop-shadow-[0_0px_30px#1BABFE] hover:border-[#8E78D3]">
                            <div className=" flex flex-col items-center pt-[24px] pb-[17px]">
                                <img src={NFT} alt="NFT" />
